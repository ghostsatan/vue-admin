<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input placeholder="标题" style="width: 200px;" v-model="listQuery.title" class="filter-item" />
    ...
    <el-table
      ...
      <el-table-column label="日期" width="150px" align="center" prop='timestamp'>
        <template slot-scope="scope">
          <span>{{ scope.row.timestamp}}</span>
        </template>
      </el-table-column>
      <el-table-column label="标题" min-width="150px" prop='type'>
        <template slot-scope="scope">
      ...
      <el-table-column v-if="showReviewer" label="审核者" width="110px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="阅读数量" align="center" width="95">
        <template slot-scope="scope">
...
// import waves from '@/directive/waves' //按钮水波效果
// import { parseTime } from '@/utils'//时间过滤器
